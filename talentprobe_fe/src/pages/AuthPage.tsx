  ...
  return (
    <div className="hidden lg:flex flex-col justify-between p-10 xl:p-14 bg-gradient-hero text-primary-foreground relative overflow-hidden">
      ...
      <div className="relative flex items-center gap-3">
        <img src="/welkdock_logo.png" alt="Welkdock Technologies logo" className="h-12 w-12 rounded-xl object-contain bg-white/90 p-1" />
        <div>
          <span className="text-lg font-semibold tracking-tight">Talent Probe</span>
          <span className="ml-2 inline-flex items-center gap-1 text-xs font-bold tracking-widest opacity-90">
            🇦🇪 UAE
          </span>
          <p className="text-[11px] opacity-80 mt-0.5">by Welkdock Technologies</p>
        </div>
      </div>
      ...
      <div className="relative space-y-6">
        <div>
          ...
          <p className="mt-4 text-base leading-relaxed opacity-80">
            Talent Probe uses Google sign-up and sign-in only, giving you a secure and faster access experience.
          </p>
        </div>
      ...
      <p className="relative text-xs opacity-50">
        © {new Date().getFullYear()} Talent Probe UAE by Welkdock Technologies. All rights reserved.
      </p>
    </div>
  );
}
    ...
    <div className="grid min-h-screen lg:grid-cols-2">
      ...
      <div className="relative flex flex-col items-center justify-center px-4 sm:px-6 py-12 bg-background">
        ...
        <div className="mb-8 flex items-center gap-3 lg:hidden">
          <img src="/welkdock_logo.png" alt="Welkdock Technologies logo" className="h-10 w-10 rounded-xl object-contain" />
          <div>
            <span className="text-base font-semibold text-foreground">Talent Probe 🇦🇪 UAE</span>
        ...
        <div className="w-full max-w-md animate-fade-up">
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Manual email/password login has been removed. Use your Google account to access Talent Probe.
            </p>
          </div>
